...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input2_nc', type=int, default=1, help='# of input2 image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--input3_nc', type=int, default=3, help='# of input3 image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--light_res', type=int, default=1, help='Light plane resolution')
        parser.add_argument('--intermediate_nc', type=int, default=1, help='# of intermadiate feature channels:')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in the first conv layer')
        parser.add_argument('--netD', type=str, default='basic', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='resnet_9blocks', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        parser.add_argument('--D_input', type=str, default='AC', help='Discriminator input [A | AC]')
        parser.add_argument('--G_input', type=str, default='A', help='Genrator input [A | AC]')
        ...
        parser.add_argument('--bp_nr_tap', type=int, default=31, help='tap of gaussian filter to NR brighest point.')
