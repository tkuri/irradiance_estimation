    ...
    if opt.test_mode <= 1: 
        ...
        for i, data in enumerate(dataset):
            ...
            if not opt.no_save_image:        
                ...
                save_images(webpage, visuals, img_path, opt, aspect_ratio=opt.aspect_ratio, width=opt.display_winsize, gain=opt.result_gain, multi=opt.show_multi, resize=False)
