...
class MiDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(25):
            img_path = self.dataroot + '/data/' + path + '/dir_{}_mip2_input.jpg'.format(i)
            srgb_img.append(Image.open(img_path).convert('RGB'))

            L_path = self.dataroot + '/data/' + path + '/dir_{}_mip2_L.jpg'.format(i)
            L.append(Image.open(L_path).convert('RGB'))

            SH_path = self.dataroot + '/data/' + path + '/dir_{}_mip2_SH.jpg'.format(i)
