...
class Aligned3TmMaxRndOneDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        A = ABC.crop((0, h25*Aidx, w3, h25*(Aidx+1)))
        B = ABC.crop((w3, h25*BCidx, w3*2, h25*(BCidx+1)))
        C = ImageOps.flip(ABC.crop((w3*2, h25*BCidx, w, h25*(BCidx+1))))
        C = C.convert("L")
        _, vmax = C.getextrema()
