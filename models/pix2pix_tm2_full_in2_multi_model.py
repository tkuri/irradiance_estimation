...
class Pix2PixTm2FullIn2MultiModel(BaseModel):
    ...
    def forward(self):
        ...
        ltm = ltm.view(-1, ltm.size(1)*self.real_B.size(1), self.real_B.size(2), self.real_B.size(3)) #[25, 25x3, 256, 256]
        ...
        self.ltm_slice24 = torch.clamp((ltm[:, [24, 25+24, 25*2+24], :, :] - 0.5) / 0.5, min=-1.0, max=1.0) # [25, 3, 256, 256]
