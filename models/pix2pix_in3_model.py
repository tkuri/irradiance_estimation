...
class Pix2PixIn3Model(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'real_B', 'real_C', 'real_D']
        ...
        self.netG = networks.define_G(opt.input_nc + opt.input2_nc + opt.input3_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
    ...
    def forward(self):
        ...
        self.fake_B = self.netG(self.real_ADC)  # G(A)
