...
class BrightestCasModel(BaseModel):
    ...
    def eval_brightest_pixel(self, idx=0):
        ...
        res_pr = self.eval_bp_pr(self.mask, self.gt_BA, self.gt_BP, self.gt_BC, self.pr_BA, self.pr_BP, '')
        res_pr2 = self.eval_bp_pr(self.mask, self.gt_BA, self.gt_BP, self.gt_BC, self.pr_BA2, self.pr_BP2, '2')
